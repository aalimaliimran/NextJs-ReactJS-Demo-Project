...
// Router URL get last path segment
...
export default async function handler(req, res){
  ...
  /* ========================================================================================== */
/* Next/React Error Handlings */
Error = Error: MUI: `capitalize(string)` expects a string argument.
Solution = missed someting as argument/props example: I missed to pass vertical and horizontal props in snackbar
